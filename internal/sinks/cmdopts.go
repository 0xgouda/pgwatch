...
type CmdOpts struct {
	...
	MaintenanceInterval   string        `long:"maintenance-interval" mapstructure:"maintenance-interval" description:"Run sinks maintenance tasks (e.g., removing old metrics) with this interval; set to zero to disable. Must be a valid PostgreSQL interval." default:"12 hours" env:"PW_MAINTENANCE_INTERVAL"`
